...
#ifndef LV_ATTRIBUTE_IMG_LIGHT_ON
#define LV_ATTRIBUTE_IMG_LIGHT_ON
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_LIGHT_ON uint8_t light_on_map[] = {
